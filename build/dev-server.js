...
var recom = require('../data/recommend.json')

var animations = require('../data/animation.json')

var disport = require('../data/disport.json')
...
router.get('/disport', function (req, res) {
  res.json({
    error: 0,
    data: disport
  })
